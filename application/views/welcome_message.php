...
<html lang="en">
	<head>
		...
		<meta property="og:image" content="../images/landing/logo.png" />
...
<?php
		...
		echo form_open('welcome/signup');
          echo '<div class="form-group col-md-6">';
            //echo form_label('First Name','firstName');
			$fndata = array('name' => 'firstName', 'id' => 'firstName', 'placeholder' => 'First Name');
			echo form_input($fndata);
          ...
          echo '</div>';
          echo '<div class="form-group col-md-6">';
			$lndata = array('name' => 'lastName', 'id' => 'lastName', 'placeholder' => 'Last Name');
			echo form_input($lndata);
            //<input type="text" class="form-control" id="lastName" name="lastName" pattern="^[,A-Za-z]{1,}$" placeholder="Last Name"
            //data-error="Must be alphabetical" required/>
            //<div class="help-block with-errors"></div>
          echo '</div>';
          echo '<div class="form-group col-md-12">';
            $emdata = array('name' => 'userEmail', 'id' => 'userEmail', 'placeholder' => 'Email Address');
          ...
          echo '</div>';
          echo '<div class="form-group col-md-12">';
            $pwdata = array('name' => 'userPassword', 'id' => 'userPassword', 'placeholder' => 'Password');
          ...
          echo '</div>';
          echo '<div class="form-group col-md-12">';
			$btndata = array('type' => 'submit', 'class'=>'btn btn-primary', 'name' => 'signupbtn', 'id' => 'signupbtn', 'content' => 'Sign Up');
            echo form_button($btndata);
